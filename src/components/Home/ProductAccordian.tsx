            ...
            <div className=" sm:ml-[-10px]">
                ...
                >
                    <div className="flex items-center justify-between">
                        <p>Are candles safe for babies to toddlers?</p>
                        {activeIndex === 1 ? (
                    ...
                    {activeIndex === 1 && (
                        <p className="text-sm my-3 text-[#555659] sm:w-56">
                            Absolutely, because we just use organic ingredients and do not use hazardous chemicals.
                        </p>
                    )}
                </div>
                ...
                >
                    <div className="flex items-center justify-between">
                        <p>After the smell runs out, will it pollute the environment?</p>
                        {activeIndex === 2 ? (
                            <MinimizeOutlinedIcon
